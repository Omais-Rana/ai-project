    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 overflow-visible">
                                ...
                                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                                    ...
                                    <div class="py-3">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-gray-900 group-hover:text-green-900">Quiz
                                                </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-gray-900 group-hover:text-blue-900">Summary
                                                </div>
                                                <div class="text-xs text-gray-500 mt-1">Quick overview of key points and
                                                    takeaways</div>
                                            </div>
        ...
        <div x-show="loading" x-cloak x-transition:enter="transition ease-out duration-200"
            ...
            <div class="bg-white rounded-2xl p-8 shadow-2xl max-w-sm mx-4 text-center">
                ...
                <p class="text-sm text-gray-600">Please wait while we analyze your document and create the study materials...</p>
            </div>
        </div>
    </div>
</div>
